...
public class MecAutoKPSNov28 extends LinearOpMode {
    ...
    HardwarePowerPlay BumbleBee = new HardwarePowerPlay();
    ...
    public void runOpMode() throws InterruptedException {
        ...
        BumbleBee.DriveStraight(.5, 500, 1); //Forward
        Thread.sleep(1000);
        BumbleBee.DriveSideways(1,1000,1); //Drive Right
        Thread.sleep(500);
        BumbleBee.DriveSideways(1,1500,-1); //Drive Right
        Thread.sleep(500);
        BumbleBee.DiagonolForward(.5, 1000, -1); //Backward
        Thread.sleep(250);
